...
Source0:	https://github.com/quotient-im/Quaternion/archive/v%{version}/%{oname}-%{version}-%{beta}.tar.gz
Source1:	https://github.com/quotient-im/libQuotient/archive/0.6.6/libQuotient-0.6.8.tar.gz
